...
struct __entry {
	...
	/* gzip */
	{STT_KEY(1, SYSCALL_OPENAT, FLAG_READ), 2},
	{STT_KEY(2, SYSCALL_OPENAT, FLAG_CREATE), 3},
	{STT_KEY(3, SYSCALL_WRITE, 0), 4},
	{STT_KEY(4, SYSCALL_UNLINKAT, 0), STATE_GZIP},
	{STT_KEY(4, SYSCALL_UNLINK, 0), STATE_GZIP}
};
